...
export const TEMPLATE_DEFINITIONS: TemplateDefinition[] = [
  ...
  definition({
    ...
    audience: 'provider',
    eventType: 'booking_confirmation',
    label: 'Provider booking confirmation WhatsApp',
    description: 'WhatsApp message sent to staff when a new booking is confirmed.',
    supportsSubject: false,
    systemDefault: {
      subject: null,
      body:
  ...
  definition({
    ...
    audience: 'provider',
    eventType: 'reminder',
    label: 'Provider reminder WhatsApp',
    description: 'WhatsApp reminder sent to staff before an appointment.',
    supportsSubject: false,
    systemDefault: {
      subject: null,
      body:
        '*Appointment reminder ({{reminder_label}})*\n\nHi {{provider_name}},\nReminder about an appointment on your schedule.\n\n*Service:* {{service_name}}\n*Customer:* {{customer_name}}\n*When:* {{appointment_when_plain}}\n\n*View in dashboard*\n{{admin_appointment_url}}',
    },
  }),
  definition({
    channel: 'whatsapp',
    audience: 'provider',
    eventType: 'rescheduled',
    label: 'Provider rescheduled WhatsApp',
    description: 'WhatsApp message sent to staff when an appointment is rescheduled.',
    supportsSubject: false,
    systemDefault: {
      subject: null,
      body:
  ...
  definition({
    ...
    audience: 'provider',
    eventType: 'cancelled',
    label: 'Provider cancellation WhatsApp',
    description: 'WhatsApp message sent to staff when an appointment is cancelled.',
    supportsSubject: false,
    systemDefault: {
      subject: null,
      body:
