...
import { isFeaturedPlan } from '@/lib/plan-cards';
...
const orchestrationPillars: {
...
}[] = [
  {
    ...
    text: 'Clear customer flow with service intelligence, staff logic, and fast slot confirmation.',
    icon: Sparkles,
    tone: 'from-brand-500/20 to-sky-500/15',
  },
  {
    title: 'Role-based execution',
    text: 'Admins, managers, and staff get focused surfaces built for speed and clarity.',
    icon: UserCog2,
...
const roleSnapshots = [
  ...
  },
  {
    ...
    points: ['Queue visibility by status', 'Staff load balancing', 'Fast reassign and follow-up'],
  },
  {
    role: 'Staff',
...
const coreCapabilities: {
  ...
  },
  {
    ...
    text: 'Balance staff load and detect bottlenecks before they affect customer experience.',
    icon: LineChart,
...
export default function HomePage() {
  ...
  if (orgSlug) {
    return <TenantOrgGate orgSlug={orgSlug} orgFromQuery={orgFromQuery} />;
  }
  ...
  return (
    <PageTransition>
      <div className="overflow-hidden">
        <section
          id="overview"
          className="scroll-mt-28 relative border-b border-slate-200/80 bg-gradient-to-b from-white via-slate-50/70 to-white dark:border-slate-800 dark:from-slate-950 dark:via-slate-900/55 dark:to-slate-950"
        >
        ...
        <section
          id="why-choose-us"
          className="scroll-mt-28 bg-surface-base py-14 sm:py-16"
        >
          <div className="mx-auto max-w-6xl px-5 sm:px-6">
            <motion.div
        ...
        <section
          id="how-it-works"
          className="scroll-mt-28 border-y border-slate-200/80 bg-gradient-to-br from-slate-100 via-white to-slate-50 py-14 sm:py-16 dark:border-slate-800 dark:from-slate-950 dark:via-slate-900 dark:to-brand-950"
        >
          <div className="mx-auto max-w-6xl px-5 sm:px-6">
        ...
        <section
          id="pricing"
          className="scroll-mt-28 border-b border-slate-200/80 bg-white py-14 sm:py-16 dark:border-slate-800 dark:bg-slate-950"
        >
          <div className="mx-auto max-w-6xl px-5 sm:px-6">
            <motion.div
              initial={{ opacity: 0, y: 10 }}
