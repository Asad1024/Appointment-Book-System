...
import { WaitlistTabPanel } from '@/components/appointments/WaitlistTabPanel';
...
export default function ProviderDashboardPage() {
  ...
  const [dashboardView, setDashboardView] = useState<DashboardView>(() => {
    ...
    const stored = localStorage.getItem('provider_dashboard_view');
  ...
  }, [calendarRangeReady, dashboardView, rangeFrom, rangeTo, statusFilter]);
  ...
  useRealtimeEvents((event) => {
    ...
    if (event.type === 'waitlist.updated') {
