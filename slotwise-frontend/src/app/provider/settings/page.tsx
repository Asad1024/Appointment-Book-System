    ...
    void (async () => {
      ...
      try {
        const [me, provider] = await Promise.all([
          fetchMe(),
          apiAuth<{ phone?: string | null }>('/catalog/me/provider').catch(() => null),
        ]);
        setForm((prev) => ({
          ...prev,
  ...
  async function saveProfile(e: React.FormEvent) {
    ...
    try {
      ...
      const [updated] = await Promise.all([
        ...
        apiAuth<{ phone?: string | null }>('/catalog/me/provider', {
          method: 'PATCH',
                ...
                <form className="space-y-6" onSubmit={saveProfile}>
                  <div>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      ...
                      <div className="sm:col-span-2">
                        <Label htmlFor="provider-phone">Mobile number (WhatsApp)</Label>
                        <PhoneInput
                          id="provider-phone"
                          value={form.phone}
                        ...
                        />
                        <p className="mt-1 text-xs text-text-muted">
                          Booking alerts and appointment reminders are sent to this number.
                        </p>
                      </div>
                    </div>
                  </div>
