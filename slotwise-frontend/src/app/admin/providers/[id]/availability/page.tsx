              ...
              <Card className="border-slate-200 shadow-sm dark:border-slate-800">
                <CardBody className="p-5">
                  ...
                  <dl className="space-y-3 text-sm">
                    <div>
                      <dt className="text-xs font-medium uppercase tracking-wide text-text-muted">Staff</dt>
              ...
              <Card className="border-slate-200 shadow-sm dark:border-slate-800">
                <CardBody className="p-5">
                  ...
                  <ul className="space-y-2 text-sm text-text-secondary">
                    ...
                    <li>Save schedule updates after editing staff availability.</li>
                  </ul>
                </CardBody>
              </Card>
              ...
              <Card className="border-slate-200 shadow-sm dark:border-slate-800">
                <CardBody className="p-5">
                  ...
                  <p className="text-sm text-text-secondary">
                    Manage invite status, profile details, and assigned services from the staff list.
                  </p>
                  <Link
