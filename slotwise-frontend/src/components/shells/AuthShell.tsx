...
export function AuthShell({
  ...
  /** Logo link target; defaults to platform home. Use tenant customer landing for customer auth. */
  logoHref?: string;
}) {
  return (
        ...
        <Card className="w-full max-w-md shadow-float">
          <CardContent className="p-8">
            <div className="mb-6 flex items-center justify-between">
              <Logo href={logoHref} className="hidden lg:flex" />
