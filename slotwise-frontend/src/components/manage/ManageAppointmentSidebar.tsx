...
import { buildGoogleCalendarUrl, calendarEventFromParts } from '@/lib/calendar-export';
    ...
    <aside className="space-y-4">
      <Card>
        <CardBody className="space-y-4 !p-8 sm:!p-10">
          ...
          <Button type="button" variant="outline" className="w-full justify-start gap-2" onClick={onDownloadIcs}>
            <CalendarPlus className="h-4 w-4" />
