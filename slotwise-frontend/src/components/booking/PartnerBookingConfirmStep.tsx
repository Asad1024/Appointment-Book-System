...
import { countryFromTimezone, toPhoneInputCountry } from '@/lib/phone';
...
export function PartnerBookingConfirmStep({
  ...
  const phoneDefaultCountry = countryFromTimezone(customerTimezone);
              ...
              <Controller
                ...
                render={({ field }) => (
                  <PhoneInput
                    ...
                    onBlur={field.onBlur}
                    invalid={!!form.formState.errors.customerPhone}
                  />
                )}
              />
            </div>
