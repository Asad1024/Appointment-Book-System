...
export function AdminLocationsCard({ locations, onLocationsChange }: Props) {
  ...
  async function addLocation(e: React.FormEvent) {
    ...
    const locationPhone = newLoc.phone.trim();
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-text-secondary">
                Add offices or branches. Use the header switcher to filter Services, Staff, and
        ...
        {adding && (
          ...
          >
            ...
            <div>
              ...
              <PhoneInput
                value={newLoc.phone}
                onChange={(value) => setNewLoc({ ...newLoc, phone: value ?? '' })}
              />
            </div>
