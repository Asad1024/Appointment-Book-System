...
const READ_STORAGE_KEY = 'slotwise_notifications_read_ids';
...
export default function AdminNotificationsPage() {
  ...
  const buildQuery = useCallback(() => {
    ...
    return q;
  }, [locationId, status, channel, searchQuery]);
          ...
          <div className="flex flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-5 lg:px-6">
            <div>
              ...
              <p className="mt-1 text-sm text-text-secondary">
                Delivery activity for booking reminders and updates
              </p>
                        ...
                        >
                          ...
                          <td className="px-4 py-3">
                            <div className="flex flex-nowrap items-center justify-end gap-1.5">
                              <Link
                                href={`/admin/appointments/${item.appointment.id}`}
